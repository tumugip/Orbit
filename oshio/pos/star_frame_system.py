...
from star_da_concept_extractor import DA_Concept
import requests
import json
...
def next_system_da(frame):
    ...
    if frame["place"] == "" and frame["date"] == "" and frame["time"] == "" and frame["type"] == "":
        return "open-prompt"
    # 空のスロットがあればその要素を質問する
    elif frame["place"] == "":
        return "ask-place"
...
while True:
    ...
    if sys_da == "tell-info":
        ...
        print("{} {}時の{}では以下の{}が見えます".format(new_date, clock, place,_type))
