...
# 時間のリスト
times=['5時','6時','7時','8時','9時','10時','11時','12時','0時','1時','2時','3時','4時','17時','18時','19時','20時','21時','22時','23時','24時']
...
# 学習用ファイルの書き出し先 
fp = open("comb_concept_samples.dat","w")

da = ''
# eamples.txt ファイルの読み込み
for line in open("comb_examples.txt","r"):
    line = line.rstrip()
